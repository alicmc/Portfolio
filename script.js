const projects = [
  {
    ...
    tag: "Product",
    description: "A release dashboard that turns deploy health, approvals, and incidents into one fast operator view.",
  ...
  },
  {
    title: "Signal Forge",
    tag: "Data",
    description: "A feature pipeline for ranking noisy events and exposing the right signal at the right moment.",
  ...
  },
  {
    title: "Pocket Orbit",
    tag: "Creative",
    description: "A tiny canvas playground with soft physics, generative motion, and shareable scenes.",
    stack: ["Canvas", "Vite", "Web APIs"],
    accent: "255, 103, 180",
    url: "#"
  },
  {
    title: "Trace Room",
    tag: "Systems",
    description: "A debugging surface that stitches logs, traces, user sessions, and deploy diffs into one story.",
  ...
  },
  {
    title: "Northstar CRM",
    tag: "Product",
    description: "A compact relationship workspace with account timelines, reminders, and keyboard-first workflows.",
  ...
  },
  {
    title: "Batch Pilot",
    tag: "Systems",
    description: "A job orchestration UI for retries, queue pressure, audit trails, and human-in-the-loop recovery.",
  ...
  },
  {
    title: "Metric Mural",
    tag: "Data",
    description: "An analytics wall for spotting drift, breakouts, cohorts, and product bets without spreadsheet chaos.",
  ...
  },
  {
    title: "Studio Keys",
    tag: "Creative",
    description: "A design-token lab for exploring palettes, motion curves, spacing, and component states in one place.",
...
function applyFilter(filter) {
  ...
  activeProjects = filter === "all" ? [...projects] : projects.filter((project) => project.tag === filter);
...
function resizeSky() {
  ...
  const starCount = Math.min(180, Math.max(72, Math.floor(window.innerWidth / 8)));
...
function drawStar(star, time) {
  ...
  const pulse = reducedMotion ? 1 : 0.58 + Math.sin(time * 0.002 + star.twinkle) * 0.32;
